...
import { PlanListComponent } from './dashboard/plan/plan-list/plan-list.component';
import { NormalPlanComponent } from './dashboard/plan/normal-plan/normal-plan.component'; // a plugin
